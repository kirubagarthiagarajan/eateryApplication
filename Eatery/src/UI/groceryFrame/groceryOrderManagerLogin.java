 ...
 * @author ktkir
 */
public class groceryOrderManagerLogin extends javax.swing.JFrame {

    /**
     * Creates new form groceryOrderManagerLogin
     */
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Please enter your Grocery Order Manager Passcode to Login");
    ...
    private void btnPatientLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPatientLoginActionPerformed
        ...
        if(!passcode.getText().equals(""))
        {
            ...
            if(passcode.getText().equals(passCode))
            {
                groceryOrderManagerFrame grocManage= new groceryOrderManagerFrame(eatery);
                grocManage.setVisible(true);
                this.dispose();
            }
            else
            {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(groceryOrderManagerLogin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
//                new groceryOrderManagerLogin().setVisible(true);
            }
        });
    }
