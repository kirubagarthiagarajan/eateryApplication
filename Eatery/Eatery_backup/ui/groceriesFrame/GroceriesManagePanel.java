...
public class GroceriesManagePanel extends javax.swing.JPanel {
    ...
    public GroceriesManagePanel(EateryEnterprise eatery) {
        initComponents();
        this.eatery=eatery;
...
displayFoodTable();// (int groceryId, String name, double price, int quantity)
    ...
    private void btnaddgroceryActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnaddgroceryActionPerformed
        ...
        if(!tfgroceryid.getText().equals("") && !tfgroceryname.getText().equals("") && !tfquantity.getText().equals("")&& !tfprice.getText().equals("") )
        {
            ...
            {
              JOptionPane.showMessageDialog(this, "Grocery id should be all numbers!");  
            }
            else if(!tfquantity.getText().matches("[0-9]+"))
            {
                JOptionPane.showMessageDialog(this, "Quantity should be all numbers!"); 
            }
            else if(!tfprice.getText().matches("[0-9]+"))
            {
                JOptionPane.showMessageDialog(this, "Price should be all numbers!"); 
            }
            ...
            else
            {
               eatery.addGrocery(Integer.parseInt(tfgroceryid.getText()),tfgroceryname.getText(),Double.parseDouble(tfprice.getText()) , Integer.parseInt(tfquantity.getText()));
                JOptionPane.showMessageDialog(this, "Food added to Grocery menu!");
