 ...
 * @author HARISH
 */
public class GroceriesLogin extends javax.swing.JFrame {

    /**
     * Creates new form GroceriesLogin
     */
    private String passCode= "sysadmin@123";
    private EateryEnterprise eatery;
    
    public GroceriesLogin(EateryEnterprise eatery) {
        initComponents();
        this.eatery=eatery;
    }
    ...
    private void btnloginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnloginActionPerformed
        // TODO add your handling code here:
          if(!tfpasscode.getText().equals(""))
          {
              ...
              {
                  GroceriesManagement groceriesmanagement = new GroceriesManagement(eatery);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GroceriesLogin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
//                new GroceriesLogin().setVisible(true);
            }
        });
    }
