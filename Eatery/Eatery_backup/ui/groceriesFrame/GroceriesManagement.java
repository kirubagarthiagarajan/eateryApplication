 ...
 * @author HARISH
 */
public class GroceriesManagement extends javax.swing.JFrame {

    /**
     * Creates new form GroceriesManagement
     */
    private EateryEnterprise eatery;
    
    public GroceriesManagement(EateryEnterprise eatery) {
        initComponents();
        this.eatery=eatery;
    }
    ...
    private void btngroceriesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btngroceriesActionPerformed
        ...
        GroceriesManagePanel groceriesmanagement = new GroceriesManagePanel(eatery);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GroceriesManagement.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
    //            new GroceriesManagement().setVisible(true);
            }
        });
    }
